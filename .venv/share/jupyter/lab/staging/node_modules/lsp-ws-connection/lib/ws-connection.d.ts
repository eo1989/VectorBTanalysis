...
import { ILspConnection, ILspOptions, IPosition, ITokenInfo, IDocumentInfo, AnyLocation, AnyCompletion } from './types';
/**
...
export declare class LspWsConnection extends events.EventEmitter implements ILspConnection {
    ...
    getCompletion(location: IPosition, token: ITokenInfo, documentInfo: IDocumentInfo, emit?: boolean, triggerCharacter?: string, triggerKind?: protocol.CompletionTriggerKind): Promise<AnyCompletion>;
