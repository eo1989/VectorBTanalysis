...
var Constants;
(function (Constants) {
    Constants.SHORT_PLUGIN_NAME = 'jupyterlab_code_formatter';
    Constants.FORMAT_COMMAND = `${Constants.SHORT_PLUGIN_NAME}:format`;
    Constants.FORMAT_ALL_COMMAND = `${Constants.SHORT_PLUGIN_NAME}:format_all`;
    ...
    Constants.PLUGIN_VERSION = '1.3.6';
