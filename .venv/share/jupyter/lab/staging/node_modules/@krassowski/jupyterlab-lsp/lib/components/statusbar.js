...
import { caretDownIcon, caretUpIcon, stopIcon, circleEmptyIcon, circleIcon } from '@jupyterlab/ui-components';
...
(function (LSPStatus) {
    ...
    class Model extends VDomModel {
        constructor(widget_adapter_manager) {
            super();
        ...
        get status() {
            ...
            let documents_with_servers = new Set();
