...
export class NotebookAdapter extends JupyterLabWidgetAdapter {
    constructor(editor_widget, jumper, app, completion_manager, rendermime_registry, connection_manager) {
        super(app, editor_widget, rendermime_registry, 'completer:invoke-notebook', connection_manager);
        this.is_ready = () => {
            var _a;
