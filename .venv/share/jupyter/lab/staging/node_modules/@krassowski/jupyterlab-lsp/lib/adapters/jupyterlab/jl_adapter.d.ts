...
export declare abstract class JupyterLabWidgetAdapter implements IJupyterLabComponentsManager {
    ...
    isDisposed: boolean;
    protected constructor(app: JupyterFrontEnd, widget: IDocumentWidget, rendermime_registry: IRenderMimeRegistry, invoke: string, connection_manager: DocumentConnectionManager);
    ...
    invoke_completer(kind: CompletionTriggerKind): Promise<any>;
