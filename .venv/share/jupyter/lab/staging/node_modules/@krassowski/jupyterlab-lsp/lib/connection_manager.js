...
export class DocumentConnectionManager {
    ...
    async connect_socket(options) {
        ...
        // of connecting.
        const connection = await Private.connection(language, language_server_id, uris, this.on_new_connection);
    ...
    updateServerConfigurations(allServerSettings) {
        for (let language_server_id in allServerSettings) {
            const parsedSettings = expandDottedPaths(allServerSettings[language_server_id].serverSettings);
...
(function (Private) {
     ...
     */
    async function connection(language, language_server_id, uris, onCreate) {
        if (_promise == null) {
